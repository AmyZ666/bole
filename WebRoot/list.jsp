			...
			<div id="search_box">
				<form id="searchForm" name="searchForm" action="list.jsp"
					...
					<input type="text" id="search_input" name="kd" tabindex="1"
						value="前端开发" placeholder="请输入职位名称，如：产品经理" /> <input type="hidden"
	...
	overflow: hidden;
			...
			<dl class="hotSearch">
				...
				<%
				 ...
				 %>
							<dd>
								<a href="list.jsp?<%=pro.getId() %>"><%=pro.getName() %></a>
							</dd>
							<%
						}
					}
			...
			<dl class="workplace" id="workplaceSelect">
				...
				<dd id="box_expectCity" class="searchlist_expectCity dn">
					...
					<dl>
						<dt>ABCDEF</dt>
						<dd>
							<span>北京</span> <span>长春</span> <span>成都</span> <span>重庆</span> <span>长沙</span>
							<span>常州</span> <span>东莞</span> <span>大连</span> <span>佛山</span> <span>福州</span>
						</dd>
					</dl>
					<dl>
						<dt>GHIJ</dt>
						<dd>
							...
							<span>海口</span> <span>杭州</span> <span>惠州</span> <span>金华</span> <span>济南</span>
							<span>嘉兴</span>
						</dd>
					</dl>
					<dl>
						<dt>KLMN</dt>
						<dd>
							<span>昆明</span> <span>廊坊</span> <span>宁波</span> <span>南昌</span> <span>南京</span>
							<span>南宁</span> <span>南通</span>
						</dd>
					</dl>
					<dl>
						<dt>OPQR</dt>
					...
					<dl>
						...
						<dd>
							...
							<span>深圳</span> <span>苏州</span> <span>天津</span> <span>太原</span> <span>台州</span>
						</dd>
					</dl>
					<dl>
						<dt>WXYZ</dt>
						<dd>
							<span>武汉</span> <span>无锡</span> <span>温州</span> <span>西安</span> <span>厦门</span>
							<span>烟台</span> <span>珠海</span> <span>中山</span> <span>郑州</span>
						</dd>
					</dl>
				</dd>
			</dl>
			...
			<ul class="hot_pos reset">
				<li class="odd clearfix">
					<div class="hot_pos_l">
						...
						<br /> <span><em class="c7">职位诱惑：</em>借移动医疗大势享受坐直升飞机的职场发展</span>
						<br /> <span>1天前发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
						...
						<div class="mb10">
							<a href="h/c/1712.jsp" title="紫色医疗" target="_blank">紫色医疗</a>
						</div>
						<span><em class="c7">领域： </em>移动互联网 ,健康医疗</span> <span><em
							class="c7">创始人：</em> Lu</span> <br /> <span><em class="c7">阶段：
						</em>成长型(A轮)</span> <span><em class="c7">规模： </em>15-50人</span>
				...
				<li class="clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>8k-16k</span> <span><em
							class="c7">经验：</em> 3-5年</span> <span><em class="c7">最低学历： </em>本科</span>
						<br /> <span><em class="c7">职位诱惑：</em>第一家互联网私人银行招募各路牛人</span> <br />
						<span>09:41发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
						...
						<div class="mb10">
							<a href="h/c/7626.jsp" title="网利宝" target="_blank">网利宝</a>
						</div>
				...
				<li class="odd clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>8k-15k</span> <span><em
							class="c7">经验：</em> 3-5年</span> <span><em class="c7">最低学历： </em>大专</span>
						<br /> <span><em class="c7">职位诱惑：</em>上市公司创业型团队 五险一金 精英团队</span>
						<br /> <span>09:40发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
							<a href="toudi.jsp" target="_blank">投个简历</a>
						...
						<div class="mb10">
							<a href="h/c/9725.jsp" title="淘米" target="_blank">淘米</a>
						</div>
				...
				<li class="clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>8k-9k</span> <span><em
							class="c7">经验：</em> 1-3年</span> <span><em class="c7">最低学历： </em>不限</span>
						<br /> <span><em class="c7">职位诱惑：</em>高薪、双休、五险一金！等你来了！</span> <br />
						<span>1天前发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
						...
						<div class="mb10">
							<a href="h/c/3228.jsp" title="艾特互动" target="_blank">艾特互动</a>
						</div>
				...
				<li class="odd clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>7k-14k</span> <span><em
							class="c7">经验：</em> 1-3年</span> <span><em class="c7">最低学历： </em>大专</span>
						<br /> <span><em class="c7">职位诱惑：</em>全新的外贸业务开发模式，等你一起来创造！</span>
					...
					<div class="hot_pos_r">
						...
						<div class="mb10">
							<a href="h/c/6922.jsp" title="快车道数据科技" target="_blank">快车道数据科技</a>
						</div>
				...
				<li class="clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>4k-7k</span> <span><em
							class="c7">经验：</em> 1-3年</span> <span><em class="c7">最低学历： </em>大专</span>
						<br /> <span><em class="c7">职位诱惑：</em>保险，双休，带薪年假等</span> <br />
						<span>1天前发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
						...
						<div class="mb10">
							<a href="h/c/9983.jsp" title="永灿" target="_blank">永灿</a>
						</div>
				...
				<li class="clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>6k-12k</span> <span><em
							class="c7">经验：</em> 1-3年</span> <span><em class="c7">最低学历： </em>不限</span>
						<br /> <span><em class="c7">职位诱惑：</em>前端主管</span> <br /> <span>3天前发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
							<a href="toudi.jsp" target="_blank">投个简历</a>
						...
						<div class="mb10">
							<a href="h/c/10763.jsp" title="鲜旅科技" target="_blank">鲜旅科技</a>
						</div>
				...
				<li class="odd clearfix">
					...
					<div class="hot_pos_r">
						...
						<div class="mb10">
							<a href="h/c/1335.jsp" title="堆糖网" target="_blank">堆糖网</a>
						</div>
				...
				<li class="odd clearfix">
					<div class="hot_pos_l">
						<div class="mb10">
							<a href="h/jobs/39231.jsp" title="JS前端开发工程师-北京-01899"
								target="_blank">JS前端开发工程师-北京-01899</a> &nbsp; <span class="c9">[北京]</span>
						</div>
						<span><em class="c7">月薪：</em>10k-20k</span> <span><em
							class="c7">经验：</em> 3-5年</span> <span><em class="c7">最低学历： </em>本科</span>
						<br /> <span><em class="c7">职位诱惑：</em>六险一金，饭补，绩效奖金，班车，领导好</span>
					...
					<div class="hot_pos_r">
						...
						<div class="mb10">
							<a href="h/c/8143.jsp" title="途家网" target="_blank">途家网</a>
						</div>
				...
				<li class="clearfix">
					<div class="hot_pos_l">
						<div class="mb10">
							<a href="h/jobs/112562.jsp" title="资深JS前端开发工程师-北京-02398"
								target="_blank">资深JS前端开发工程师-北京-02398</a> &nbsp; <span class="c9">[北京]</span>
						</div>
						<span><em class="c7">月薪：</em>15k-25k</span> <span><em
							class="c7">经验：</em> 3-5年</span> <span><em class="c7">最低学历： </em>本科</span>
						<br /> <span><em class="c7">职位诱惑：</em>六险一金，饭补，班车，晋升机制，氛围好</span>
				...
				<li class="odd clearfix">
					<div class="hot_pos_l">
						...
						<br /> <span><em class="c7">职位诱惑：</em>精英团队；有竞争力的薪酬</span> <br />
						<span>1天前发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
						...
						<div class="mb10">
							<a href="h/c/3786.jsp" title="宜信公司" target="_blank">宜信公司</a>
						</div>
				...
				<li class="clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>6k-12k</span> <span><em
							class="c7">经验：</em> 1-3年</span> <span><em class="c7">最低学历： </em>大专</span>
						<br /> <span><em class="c7">职位诱惑：</em>C轮融资，工作环境好，待遇优</span> <br />
						<span>1天前发布</span>
					</div>
					<div class="hot_pos_r">
						<div class="apply">
						...
						<div class="mb10">
							<a href="h/c/3564.jsp" title="同程旅游" target="_blank">同程旅游</a>
						</div>
				...
				<li class="odd clearfix">
					<div class="hot_pos_l">
						...
						<span><em class="c7">月薪：</em>6k以上</span> <span><em
							class="c7">经验：</em> 1-3年</span> <span><em class="c7">最低学历： </em>大专</span>
						<br /> <span><em class="c7">职位诱惑：</em>年底双薪，带薪年假，周末双休，年度旅游</span>
					...
					<div class="hot_pos_r">
						...
						<div class="mb10">
							<a href="h/c/12185.jsp" title="蝶讯网" target="_blank">蝶讯网</a>
						</div>

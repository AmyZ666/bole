		...
		<div id="header">
			<div class="wrapper">
				...
				<ul id="navheader" class="reset">
					...
					<li><a rel="nofollow" href="h/corpResume/unHandleResumes.html">简历管理</a>
					</li>
		...
		<div id="container">
			<div class="user_bindSidebar">
				<dl id="user_sideBarmenu" class="user_sideBarmenu">
					...
					<dd>
						<a href="accountBind.html">帐号绑定</a>
					</dd>
					<dd>
			...
			<div style="display:none;">
				...
				<div style="overflow:auto;" class="popup " id="confirmBind1">
					...
					<div class="user_bindSuccecc">
						点击“确认绑定”后，您<span>未选择的帐号信息</span> 将被彻底删除，包括：
					</div>
					<div class="user_noRecoverInfos">
						<p class="noRecoverInfosContent">简历信息、投递记录、发布的职位、收到的简历</p>
					</div>
					<div class="user_bindBtn">
						<a id="user_confirmBind1" class="user_confirm click"
							href="javascript:;">确认绑定</a> <a class="user_backReplace"
							href="javascript:;">返回修改</a>
					</div>
				</div>
				<!--/#confirmUnbind-->
				...
				<div style="overflow:auto;" class="popup " id="confirmBind2">
					...
					<div class="user_bindBtn">
						<a id="user_confirmBind2" class="user_confirm click"
							href="javascript:;">确认绑定</a> <a class="user_backReplace"
							href="javascript:;">返回修改</a>
					</div>
				</div>
				...
				<div style="overflow:auto;" class="popup " id="confirmBind3">
					...
					<div class="user_bindBtn">
						<a id="newAccount_confirmBind1" class="user_confirm click"
							href="javascript:;">确认绑定</a> <a class="user_backReplace"
							href="javascript:;">返回修改</a>
					</div>
				</div>
				...
				<div style="overflow:auto;" class="popup" id="bindTips">
					<table>
						<tbody>
							...
							<tr>
								<td align="center"><a id="user_confirmBindTips" class="btn"
									href="javascript:;">
										<!-- 换个邮箱绑定 -->
								</a> <a class="cancel" href="login.html">退出当前帐号</a></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div style="overflow:hidden; width:500px;height:390px;"
					class="popup" id="bindReplace">
					<form style="width: 100%" id="bindReplaceForm">
						<table width="100%" height="100%">
							<tbody>
								...
								<tr>
									<td class="chooseAccount"><label class=""> <input
											type="hidden" value=""> <em></em>
											<div>
												<div class="f16 c7">
													保留邮箱：<span value="1" id="user_oldAccount" class="c3"></span>帐号下的信息
												</div>
												<div class="acc_detail">
													<span>简历完整度：<i id="user_resumeScore"></i>分 </span> <span>投递职位数：<i
														id="user_jobCount"></i>个 </span>
												</div>
												<div class="acc_detail">
													<span>发布职位数：<i id="user_publishJob"></i>个 </span> <span>收到简历数：<i
														id="user_receiveCount"></i>份</span>
												</div>
											</div> </label> <label> <input type="hidden" value=""> <em></em>
											<div>
												<div class="f16 c7 ">
													保留 <i id="user_typeAccount"></i>： <span value="2"
														id="user_replaceAccount" class="c3"></span>帐号下的信息
												</div>
												<div class="acc_detail">
													<span>简历完整度：<i id="user_replaceResumeScore"></i>分 </span> <span>投递职位数：<i
														id="user_replaceJobCount"></i>个 </span>
												</div>
												<div class="acc_detail">
													<span>发布职位数：<i id="user_replacePublishJob"></i>个 </span> <span>收到简历数：<i
														id="user_replaceReceiveCount"></i>份</span>
												</div>
								...
								<tr>
									...
									<td align="center"><a id="user_confirmReplace" class="btn"
										href="javascript:;">确 定</a> <a id="user_cancleReplace"
				...
				<div class="popup user_popup" id="confirmUnbind">
					...
					<div class="user_bindBtn user_unbind">
						<a id="user_confirmUnbind" class="user_confirm click"
							href="javascript:;">确&nbsp;定</a> <a class="cancel"
				...
				<div class="popup user_popup" id="confirmUnbindSina">
					...
					<div class="user_bindBtn user_unbind">
						<a id="user_confirmUnbindSina" class="user_confirm click"
							href="javascript:;">确&nbsp;定</a> <a class="cancel"
							href="javascript:;">取 消</a>
					</div>
				</div>
				...
				<div style="overflow:hidden" class="popup" id="unbindService">
					...
					<h4>
						<span>5</span>秒后页面将自动跳转至开通招聘服务页
					</h4>
					<a class="btn" href="h/corpCenter/bindStep1.html">立即跳转</a>
				</div>
				<div style="overflow:hidden" class="popup"
					id="confirm_unbindService">
					<h3>确认解除与当前公司的招聘服务吗？</h3>
					<h4>解除后，您通过该公司发布的职位和收到的简历都将不可见，且不可恢复</h4>
					<div class="confirm_unbindSeerviceBtn">
						<a id="confirm_unbind" class="btn" href="javascript:;">确认解除</a> <a
							id="" class="cancel" href="javascript:;">取 消</a>
					</div>
				</div>

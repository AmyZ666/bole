						...
						<form method="post" action="company3" id="memberForm">
							...
							<div id="memberDiv">
								<div class="formWrapper">
									<input type="hidden" value="25927"
										name="leaderInfos[0].companyId">
									<div class="new_portrait">
										...
										<input type="file" value=""
											...
											name="myfiles" id="myfiles0" class="myfiles"> <input
											type="hidden" value="7" name="type" id="type0"> <input
											type="hidden" name="leaderInfos[0].photo" id="leaderInfos0">
										<em> 尺寸：120*120px <br> 大小：小于5M </em> <span
											style="display:none;" id="myfiles0_error" class="error"></span>
									</div>
							...
							<div class="clear"></div>
							<input type="submit" value="保存，下一步" id="step3Submit"
								class="btn_big fr"> <a class="btn_cancel fr"
								href="http://www.lagou.com/c/product.html">跳过</a>
						</form>
					</dd>
				</dl>
			</div>

	...
	<div id="header">
		...
		<div id="container">
			<div class="clearfix">
						...
						<dt>
							...
							<div class="jd_collection" id="jobCollection">
								<div class="jd_collection_success">
									<span>已成功收藏该职位，</span> <a class="jd_collection_page"
										href="collections.html">查看全部</a> <a class="jd_collection_x"
										href="javascript:;"></a>
								</div>
							</div>
						</dt>
				...
				<div class="content_r">
					<dl class="job_company">
						<dt>
							<a target="_blank" href="h/c/5004.html"> <img width="80"
								height="80" alt="广州百田信息科技有限公司"
								src="style/images/ff8080814356e881014357741e5910f1.jpg"
								class="b2">
								<div>
									<h2 class="fl">
								...
								<div
									...
									<div
										...
										<div
											...
											<span
												style="position: absolute; padding: 0px; margin: 0px; border: 0px none; -moz-user-select: none; cursor: pointer; background: url(style/images/img/blank.gifquot) repeat scroll 0% 0% transparent; width: 19px; height: 25px; left: 130px; top: 75px; z-index: -4626192;"
												"="" unselectable="on" class="BMap_Marker BMap_noprint"
												title=""></span>
										</div>
										<div
										...
										<div
											...
											<span
												style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 0px; height: 0px; -moz-user-select: none; left: 130px; top: 75px; z-index: -4626192;"
												unselectable="on" class="BMap_Marker"><div
													...
													<img style="border:none;margin-left:0px; margin-top:0px; "
														src="style/images/marker_red_sprite.png">
												</div>
											</span>
										</div>
										<div
											...
											<span
												style="position: absolute; padding: 0px; margin: 0px; border: 0px none; width: 20px; height: 11px; -moz-user-select: none; left: 134px; top: 89px;"
												unselectable="on"><div
									...
									<div
										...
										<div
											style="position: absolute; overflow: visible; z-index: -100; left: 140px; top: 100px; display: none;"></div>
									</div>
									<div
										style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 2; display: block;">
										<div
											style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 0; display: block;">
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -106px; top: -188px; background: none repeat scroll 0% 0% rgb(243, 241, 236);"
												width="256" height="256" id="_1_bg_12325_2569_16"></canvas>
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -362px; top: -188px; background: none repeat scroll 0% 0% rgb(243, 241, 236);"
												width="256" height="256" id="_1_bg_12324_2569_16"></canvas>
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -106px; top: 68px; background: none repeat scroll 0% 0% rgb(243, 241, 236);"
												width="256" height="256" id="_1_bg_12325_2568_16"></canvas>
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -362px; top: 68px; background: none repeat scroll 0% 0% rgb(243, 241, 236);"
												width="256" height="256" id="_1_bg_12324_2568_16"></canvas>
										</div>
										<div
											style="position: absolute; overflow: visible; top: 100px; left: 140px; z-index: 10; display: block;">
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -106px; top: -188px;"
												width="256" height="256" id="_1_poi_12325_2569_16"></canvas>
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -362px; top: -188px;"
												width="256" height="256" id="_1_poi_12324_2569_16"></canvas>
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -106px; top: 68px;"
												width="256" height="256" id="_1_poi_12325_2568_16"></canvas>
											<canvas
												style="position: absolute; width: 256px; height: 256px; left: -362px; top: 68px;"
			...
			<input type="hidden" id="userid" name="userid"
				value="68ad090107cb481fff4ef57dcc6681a1"> <input
				type="hidden" id="resend_type" name="type" value="1"> <input
				type="hidden" id="jobid" value="22194"> <input type="hidden"
				id="companyid" value="5004"> <input type="hidden"
				id="positionLng" value=""> <input type="hidden"
				id="positionLat" value="">
			...
			<div style="display:none;">
								...
								<td>
									<form class="resumeSetForm" id="resumeSetForm">
										<label class="radio"> <input type="radio" value="1"
											class="resume1" name="resumeName"> 在线简历： <span
											title="jason的简历">jason的简历</span> </label>
										<div class="setBtns">
											<a target="_blank" href="h/resume/preview.html">预览</a> | <a
												target="_blank" href="jianli.html">修改</a>
										</div>
										<div class="clear"></div>
										<label class="radio"> <input type="radio" value="0"
											class="resume0" name="resumeName"> 附件简历： <span
											class="uploadedResume red">暂无附件简历</span> </label>
										<div class="setBtns">
											<a class="downloadResume dn" href="h/nearBy/downloadResume">下载</a>
											<span class="dn">|</span> <a class="reUpload" title="上传附件简历"
												target="_blank">上传附件简历</a> <input type="file"
										...
										<label class="bgPink">默认使用此简历直接投递，下次不再提示</label> <span
											...
											value="保存设置" class="btn_profile_save btn_s">
									</form></td>
							</tr>
						</tbody>
					</table>
								...
								<td>
									<form class="resumeSetForm" id="resumeSendForm">
										...
										<label class="bgPink"><input type="checkbox"
											...
											class="setTip error"></span> <input type="submit"
											value="确认投递简历" class="btn_profile_save btn_s">
									</form></td>
							</tr>
						</tbody>
					</table>
				...
				<div class="popup" id="uploadFileSuccess">
					...
					<table width="100%">
						<tbody>
							<tr>
								<td align="center"><p>你可以将简历投给你中意的公司了。</p>
								</td>
							</tr>
							<tr>
								<td align="center"><a class="btn_s"
									href="javascript:top.location.reload();">确&nbsp;定</a>
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div style="height:240px;" class="popup" id="loginPop">
					<form id="loginForm">
						<input type="text" placeholder="请输入登录邮箱地址" tabindex="1"
							name="email" id="email"
						...
						<input type="password" placeholder="请输入密码" tabindex="2"
							name="password" id="password"
							style="background-image: url(style/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
						<span id="beError" style="display:none;" class="error"></span> <label
							for="remember" class="fl"><input type="checkbox"
							name="autoLogin" checked="checked" value="" id="remember">
							记住我</label> <a class="fr" href="h/reset.html">忘记密码？</a> <input
					...
					<div class="login_right">
						...
						<a title="使用新浪微博帐号登录" class="icon_wb" target="_blank"
							href="h/ologin/auth/sina.html"></a> <a title="使用腾讯QQ帐号登录"
							target="_blank" class="icon_qq" href="h/ologin/auth/qq.html"></a>
					</div>
				</div>
				<!--/#loginPop-->
...
#colorbox,#cboxOverlay,#cboxWrapper {
	overflow: visible;
				...
				<div style="height:300px; overflow:visible;" class="popup"
					id="infoBeforeDeliverResume">
						...
						<table width="100%">
							<tbody>
								<tr>
									...
									<td><input type="text" placeholder="姓名" name="name">
									</td>
									<td valign="middle"><span class="redstar">*</span></td>
									<td><input type="hidden" id="degree" value=""
										name="degree"> <input type="button" value="最高学历"
										id="select_degree"
										class="profile_select_190 profile_select_normal">
										<div class="boxUpDown boxUpDown_190 dn" id="box_degree"
											style="display: none;"></div></td>
								</tr>
								<tr>
									<td valign="middle"><span class="redstar">*</span></td>
									<td><input type="hidden" id="workyear" value=""
										name="workyear"> <input type="button" value="工作年限"
										id="select_workyear"
										class="profile_select_190 profile_select_normal">
									...
									<td><input type="hidden" id="expectCity" value=""
										name="expectCity"> <input type="button" value="期望工作城市"
								...
								<tr>
									<td valign="middle"><span class="redstar">*</span></td>
									<td><input type="text" placeholder="联系电话" name="tel">
									</td>
									<td valign="middle"><span class="redstar">*</span></td>
									<td><input type="text" placeholder="邮箱地址" name="email">
									</td>
								</tr>
								<tr>
									<td></td>
									<td colspan="3"><input type="hidden" value="" name="type">
										<input type="submit" value="确认并投递" class="btn"></td>
								</tr>
							</tbody>
						</table>
					</form>
				...
				<div class="popup" id="fileResumeUpload">
					<table width="100%">
						<tbody>
							<tr>
								<td>
									<div class="f18 mb10">请上传标准格式的word简历</div></td>
							</tr>
							<tr>
								<td>
									<div class="f16">
				...
				<div class="popup" id="fileResumeUploadSize">
					<table width="100%">
						<tbody>
							<tr>
								<td>
									<div class="f18 mb10">上传文件大小超出限制</div></td>
							</tr>
							<tr>
								<td>
									<div class="f16">
						...
						<tbody>
							...
							<tr>
								<td align="center"><input type="hidden" value=""
									name="type"> <a class="btn"
									href="javascript:sendResume(314873,22194,true,true);">确认投递</a>
									<a class="btn_s" href="javascript:;">放弃投递</a> <a
				...
				<!-- 投简历成功 -->
				<div style="width:440px;padding-bottom:10px;" class="popup"
					id="deliverResumesSuccess">
					<table width="100%">
						<tbody>
							<tr class="drawGGJ">
								<td align="center">
								...
								<td align="center">
									<form>
										<a class="btn_addPic" href="javascript:void(0);"> <span>选择上传文件</span>
											...
											title="支持word、pdf、ppt、txt、wps格式文件，大小不超过10M"> </a>
									</form> <a target="_blank" href="jianli.html" class="btn">完善在线简历</a></td>
							</tr>
						</tbody>
					</table>
				</div>
	...
	-->
				<div style="height:240px;" class="popup" id="activePop">
					...
					<p>
						<a id="resend" href="javascript:void(0)">重新发送验证邮件 </a> | <a
							target="_blank" href="register.html"> 换个邮箱？ </a>
					</p>
				</div>
				<!--/#activePop-->
	...
	-->
				<div class="popup" id="resend_success">
					<p>
						我们已将激活邮件发送至：<a>jason@qq.com</a>，请点击邮件内的链接完成验证。
					</p>
				</div>
				<!--/#resend_success-->
				...
				<div class="popup" id="baiduMap">
					<div id="allmap"
						...
						<div
							...
							<div
								style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 1;"></div>
							<div
...
$(function(){
	...
	$('#colorbox').on('click','#cboxClose',function(){
		...
		$(function(){
			...
			<div class="clear"></div>
			<input type="hidden" value="e789f5e7097b4c828e9d40ef39a6baf8"

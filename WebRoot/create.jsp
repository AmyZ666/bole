		...
		<div id="container">
			...
			<div class="sidebar">
				...
				<div class="subscribe_side mt20">
					...
					<div class="f18 mb10">就用伯乐招聘加速助手</div>
					<div>
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form action="http://www.lagou.com/corpPosition/preview.jsp"
							...
							<table class="btm">
								<tbody>
									<tr>
										<td width="25"><span class="redstar">*</span>
										</td>
										<td width="85">职位类别</td>
										<td><input type="hidden" id="positionType" value=""
											name="positionType"> <input type="button"
											value="请选择职位类别" id="select_category"
									...
									<tr>
										...
										<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
											...
											id="positionDetail_parent" class="mceEditor defaultSkin"><span
												...
												id="positionDetail_voice">富文本域</span>
											<table cellspacing="0" cellpadding="0" role="presentation"
													id="positionDetail_tbl" class="mceLayout"
													style="width: 544px; height: 276px;">
													<tbody>
														<tr role="presentation" class="mceFirst">
															<td class="mceToolbar mceLeft mceFirst mceLast"
																role="toolbar"><div
																	aria-labelledby="positionDetail_toolbargroup_voice"
																	role="group" id="positionDetail_toolbargroup"
																	tabindex="-1">
																	<span role="application"><span
																		style="display:none;" class="mceVoiceLabel"
																		id="positionDetail_toolbargroup_voice">工具栏</span>
																	<table align="" cellspacing="0" cellpadding="0"
																			tabindex="-1" role="presentation"
																			class="mceToolbar mceToolbarRow1 Enabled"
																			id="positionDetail_toolbar1" aria-disabled="false"
																			aria-pressed="false">
																			<tbody>
																				<tr>
																					<td
																					...
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1"><span
																							...
																							id="positionDetail_bold_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">粗体(Ctrl
																								B)</span>
																					</a>
																					</td>
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1"><span
																							...
																							id="positionDetail_italic_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">斜体(Ctrl
																								I)</span>
																					</a>
																					</td>
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1"><span
																							...
																							id="positionDetail_underline_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">下划线(Ctrl
																								U)</span>
																					</a>
																					</td>
																					<td style="position: relative"><span
																						tabindex="-1" aria-orientation="vertical"
																						role="separator" class="mceSeparator"></span>
																					</td>
																					<td style="position: relative"><a title="左对齐"
																						...
																						tabindex="-1"><span
																							...
																							id="positionDetail_justifyleft_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">左对齐</span>
																					</a>
																					</td>
																					<td style="position: relative"><a title="居中"
																						...
																						tabindex="-1"><span
																							...
																							id="positionDetail_justifycenter_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">居中</span>
																					</a>
																					</td>
																					<td style="position: relative"><a title="右对齐"
																						...
																						tabindex="-1"><span
																							...
																							id="positionDetail_justifyright_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">右对齐</span>
																					</a>
																					</td>
																					<td style="position: relative"><span
																						tabindex="-1" aria-orientation="vertical"
																					...
																					<td style="position: relative"><a title="项目列表"
																						...
																						role="button" tabindex="-1" aria-pressed="false"><span
																							class="mceIcon mce_bullist"></span><span
																							id="positionDetail_bullist_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">项目列表</span>
																					</a>
																					</td>
																					<td style="position: relative"><a title="编号列表"
																						...
																						role="button" tabindex="-1" aria-pressed="false"><span
																							class="mceIcon mce_numlist"></span><span
																							id="positionDetail_numlist_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">编号列表</span>
																					</a>
																					</td>
																					<td style="position: relative"><span
																						tabindex="-1" aria-orientation="vertical"
																					...
																					<td style="position: relative"><a title="减少缩进"
																						...
																						role="button" tabindex="-1" aria-disabled="true"><span
																							class="mceIcon mce_outdent"></span><span
																							id="positionDetail_outdent_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">减少缩进</span>
																					</a>
																					</td>
																					<td style="position: relative"><a title="增加缩进"
																						...
																						role="button" tabindex="-1"><span
																							...
																							id="positionDetail_indent_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">增加缩进</span>
																					</a>
																					</td>
																					<td style="position: relative"><span
																						tabindex="-1" aria-orientation="vertical"
																					...
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1" aria-disabled="true"><span
																							...
																							id="positionDetail_undo_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">撤销 (Ctrl
																								Z)</span>
																					</a>
																					</td>
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1" aria-disabled="true"><span
																							...
																							id="positionDetail_redo_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">恢复 (Ctrl
																								Y)</span>
																					</a>
																					</td>
																					<td style="position: relative"><span
																					...
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1" aria-disabled="true"><span
																							...
																							id="positionDetail_link_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">插入/编辑
																								超链接</span>
																					</a>
																					</td>
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1" aria-disabled="true"><span
																							...
																							id="positionDetail_unlink_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">取消超链接</span>
																					</a>
																					</td>
																					<td style="position: relative"><span
																						tabindex="-1" aria-orientation="vertical"
																					...
																					<td style="position: relative"><a
																						...
																						role="button" tabindex="-1"><span
																							class="mceIcon mce_hr"></span><span
																							id="positionDetail_hr_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">插入水平线</span>
																					</a>
																					</td>
																					<td style="position: relative"><a
																						title="切换全屏模式"
																						...
																						role="button" tabindex="-1" aria-pressed="false"><span
																							class="mceIcon mce_fullscreen"></span><span
																							id="positionDetail_fullscreen_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">切换全屏模式</span>
																					</a>
																					</td>
																					<td style="position: relative"><a
																						title="插入/编辑 图片"
																						...
																						role="button" tabindex="-1"><span
																							...
																							id="positionDetail_image_voice"
																							style="display: none;"
																							class="mceVoiceLabel mceIconOnly">插入/编辑 图片</span>
																					</a>
																					</td>
																					<td
														...
														<tr class="mceLast">
															<td class="mceIframeContainer mceFirst mceLast"><iframe
																	frameborder="0" id="positionDetail_ifr"
																	src="javascript:&quot;&quot;" allowtransparency="true"
																	title="富文本域按 ALT-F10 定位到工具栏.按 ALT-0 获取帮助。"
																	style="width: 100%; height: 253px; display: block;"></iframe>
															</td>
														</tr>
													</tbody>
												</table>
...
$(function(){
	...
	<div id="footer">
		<div class="wrapper">
			<a rel="nofollow" target="_blank" href="about.jsp">联系我们</a> <a
				target="_blank" href="http://www.lagou.com/af/zhaopin.jsp">互联网公司导航</a>

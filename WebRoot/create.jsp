			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form action="create_occupate" method="post" id="jobForm">
								...
								<tbody>
									<tr>
										...
										<td><input type="text" placeholder="请输入职位名称，如：产品经理"
											value="" name="ps.name" id="positionName"></td>
									</tr>
								</tbody>
							</table>
									...
									<tr>
										...
										<td>
											<div class="salary_range">
												<div>
													<input type="text" placeholder="例：10k-12k" value=""
														id="salaryMin" name="ps.salary" size="50"> <span>k</span>
												</div>
											</div></td>
									</tr>
									<tr>
										...
										<td><input type="text" placeholder="请输入工作城市，如：北京"
											 name="ps.address" id="workAddress"></td>
									</tr>
								</tbody>
							</table>
								...
								<tbody>
									<tr>
										...
										<td><input type="hidden" id="experience" value=""
											name="ps.exp"> <input type="button" value="请选择工作经验"
									...
									<tr>
										...
										<td><input type="hidden" id="education" value=""
											name="ps.educution"> <input type="button"
								...
								<tbody>
									...
									<tr>
										...
										<td><input type="text" placeholder="请输入详细的工作地址" value=""
											name="ps.detail_address" class="input_520" id="positionAddress">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="2">同时简历自动发送至邮箱（仅一个） <input type="text"
											value="" id="forwardEmail" name="ps.email"> <span class="error" id="beError" style="display:none"></span>
										</td>
									</tr> 
									<tr>
										<td width="25"></td>
										<td colspan="2"><input type="submit" value="预览"
											id="jobPreview" class="btn_32"> <input type="submit"

		...
		<div class="login_box">
        	<s:form id="loginForm" action="register" method="post">
        		<ul class="register_radio clearfix">
		            <li>
		            	找工作
		              	<input type="radio" value="0" name="user.status" /> 
		            </li>
		            <li>
		           	           招人
		              	<input type="radio" value="1" name="user.status" /> 
		            </li>
		        </ul> 
		        	<s:textfield name="user.userName" id="email" size="30" placeholder="请输入用户名"></s:textfield>
<!--             	<input type="text" id="email" name="user.email" tabindex="1" placeholder="请输入常用邮箱地址" />
 -->            	<s:textfield name="user.email" id="email" size="30" placeholder="请输入常用邮箱地址"></s:textfield>
...
<!--              <label class="fl registerJianJu" for="checkbox">
           		...
           		<s:submit value="注  册" id="submitLogin"></s:submit>

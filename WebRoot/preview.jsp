...
<title>简历预览-我的简历-伯乐网-最专业的互联网招聘平台</title>
			...
			<div class="profile_box" id="workExperience">
				...
				<div class="experienceShow">
					<ul class="wlist clearfix">
						<li class="clear"><span class="c9">2013.06-至今</span>
							<div>
								<img width="56" height="56" alt="上海辉硕科技有限公司"
									src="style/images/logo_default.png">
								<h3>高级产品经理</h3>
								<h4>上海辉硕科技有限公司</h4>
							</div></li>
					</ul>
					...
					<ul class="plist clearfix">
						<li class="noborder">
							<div class="projectList">
								<div class="f16 mb10">
									微盟，jason <span class="c9"> （2013.06-至今） </span>
								</div>
								<div class="dl1"></div>
							</div></li>
					</ul>
					...
					<ul class="slist clearfix">
						<li class="noborder">
							<div class="workList c7">
								<div class="f16">
									网址：<a target="_blank" href="http://www.weimob.com">http://www.weimob.com</a>
								</div>
								<p>产品</p>
							</div></li>
					</ul>

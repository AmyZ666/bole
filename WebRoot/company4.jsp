...
<title>公司产品-招聘服务-伯乐网-最专业的互联网招聘平台</title>
				...
				<dl class="c_section c_section_mid">
					...
					<dd>
						...
						<form method="post"
								...
								<div class="formWrapper">
									...
									<div class="new_product mt20">
										...
										<div id="productShow0" class="product_upload dn productShow">
											<img width="380" height="220" src=""> <span>更换产品图片<br>380*220px
												小于5M</span>
										</div>
										<input type="file" title="支持jpg、jpeg、gif、png格式，文件小于5M"
											...
											value="3" name="productInfos[0].type" id="type0"> <input
											type="hidden" name="productInfos[0].productPicUrl"
											id="productInfos0">
									</div>
							...
							<div class="clear"></div>
							<input type="submit" value="保存，下一步" id="step4Submit"
								class="btn_big fr"> <a class="btn_cancel fr"
								href="http://www.lagou.com/c/intro.html">跳过</a>
						</form>
					</dd>
				</dl>
			</div>
